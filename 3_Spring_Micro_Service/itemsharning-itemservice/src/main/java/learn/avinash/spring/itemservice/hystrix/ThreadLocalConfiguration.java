...
public class ThreadLocalConfiguration {
    ...
    private HystrixConcurrencyStrategy exisitingConcurrency;
    ...
    public  void init() {
        ...
        HystrixPlugins.getInstance().registerConcurrencyStrategy(new ThreadLocalAwareStrategy(exisitingConcurrency));
