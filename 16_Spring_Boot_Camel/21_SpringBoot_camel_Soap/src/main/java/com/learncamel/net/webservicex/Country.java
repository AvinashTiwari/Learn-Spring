...
public class Country extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Dilip/Study/ApacheCamel/TeachApacheCamel-Spring-Boot/session-codebase/soap-springws-learncamel-spring-boot-test/src/main/resources/wsdl/country.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Country.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Dilip/Study/ApacheCamel/TeachApacheCamel-Spring-Boot/session-codebase/soap-springws-learncamel-spring-boot-test/src/main/resources/wsdl/country.wsdl");
        }
        WSDL_LOCATION = url;
    }
